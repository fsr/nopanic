...
Der Fachschaftsrat (kurz: FSR) ist deine Vertretung auf Fakultätsebene.
Er wird jährlich gewählt und besteht zurzeit aus 17 Studierenden der Informatik und Medieninformatik.
...
So stellt er beispielsweise alte Prüfungen und Protokolle von Komplexprüfungen zur Verfügung \link{ftp://ftp.ifsr.de/klausuren} (nur aus dem Uninetz, bzw. via VPN zugänglich).
Damit die Qualität der Lehre weiter verbessert wird, kümmert sich der FSR um die Evaluation der einzelnen Vorlesungen.

Der FSR veranstaltet regelmäßig, ungefähr ein mal im Monat, Spieleabende mit Brett-, Karten- und digitalen Spielen in der Fakultät. Der erste findet bereits am Mittwochabend während der Erstsemestereinführung statt.
...
Wenn du etwas ausleihen möchtest, bringe bitte beim ersten Mal deinen Personalausweis mit, damit wir einen Leihschein ausstellen können, zum Teil ist auch eine Kaution notwendig.
Die Liste der Leihgegenstände und die Verleihordnung findet sich unter \link{https://www.ifsr.de/service:leihen}.
...
\textbf{Kontakt} \\
Jeden Montag trifft sich der FSR um 18:45 Uhr im großen Ratssaal (APB 1004), um unter anderem über verschiedene Aktionen, sei es ESE, Lehrevaluation, Sportturniere aber auch über Probleme und Entwicklungen an der Fakultät bzw. Universität zu diskutieren.
Du bist dabei herzlichst eingeladen, denn die Sitzung ist für alle öffentlich! Unter \link{https://www.ifsr.de/fsr:sitzung} findest du neben den Sitzungsprotokollen viele weitere nützliche Informationen.
...
Das auditorium \link{https://auditorium.inf.tu-dresden.de/} bietet dir die Möglichkeit, Fragen zu den einzelnen Lehrveranstaltungen stellen zu können.
...
Die TU Dresden bietet eine allgemeine fakultätsübergreifende Studienberatung \link{https://tu-dresden.de/studium/im-studium/beratung-und-service/zentrale-studienberatung} an.

Für eine Beratung zu einem unserer beiden großen Studiengängen sind die beiden studentischen Studienberater Katja Linnemann (Informatik) und Philipp Heisig (Medieninformatik) zuständig, die gerne bei Fragen oder Problemen zur Verfügung stehen. Erreichbar sind sie unter \textit{studienberatung-inf@ifsr.de} bzw. \textit{studienberatung-minf@ifsr.de} oder gemeinsam unter \textit{studienberatung@ifsr.de}.

Darüber hinaus gibt es für jedes Studienfach einen nicht-studentischen Studienfachberater \link{https://tu-dresden.de/ing/informatik/studium/beratung}.
