...
Auf der Seite des FSR \link{http://ftp.ifsr.de} sind viele Klausuren vergangener Jahre erhältlich (dieses Archiv ist nur aus dem Uninetz erreichbar).
...
\textbf{xkcd} \\
Informatiker-Kult-Webcomic auf \url{xkcd.com}. Du findest einige berühmte xkcd-Comics in diesem Heft.
