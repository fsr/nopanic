...
Ein Unterschied zwischen diesem Gebäude und den anderen auf dem Campus ist, dass es rund um die Uhr geöffnet ist. Auch wenn nachts mal die Türen verschlossen sein sollten, wird euch der Sicherheitsdienst gerne gegen Vorlage eures Studentenausweises die Tür öffnen und auf Wunsch auch einen der Seminarräume im Erdgeschoss aufschließen.

Sitzgelegenheiten auf den Gängen aller Etagen bieten euch genügend Platz, um euch beispielsweise mit euren Lerngruppen auf anstehende Prüfungen vorzubereiten. Weiterhin gibt es mehrere zum Teil mit Spezial-Software ausgestattete PC-Pools, die jedoch nur tagsüber geöffnet sind.

Außerdem können wir einen ziemlich schicken Außenbereich unser Eigen nennen. Dazu gehört ein Teich und viel Platz auf der Wiese zum Rumlümmeln. Dafür haben wir euch Decken zur Verfügung gestellt, die nur darauf warten, genutzt zu werden.
...
Mit dieser Idylle könnte es jedoch schon bald vorbei sein, da der Außenbereich größtenteils einem neuen Gebäude weichen soll. Neben vielen Angehörigen der Fakultät halten auch eure Studierendenvertreter dagegen und machten zuletzt mit der Aktion \#SaveTheTeich auf das Vorhaben aufmerksam~\link{https://savethetei.ch/}.

Vom Teich aus kannst du das Rechenzentrum (\enquote{Lehmann-Zentrum}) sehen. Vielleicht bekommt ihr ja die Chance, an einer der Führungen durch das Rechenzentrum teilzunehmen, die zu verschiedenen Events angeboten werden.
...
Im Foyer findet ihr eine Tafel, welche ihm und seinem Lebenswerk gedenkt.
